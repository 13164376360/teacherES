package com.zzuli.marketing.controller;
...
import com.zzuli.marketing.service.EmailInfoService;
import com.zzuli.marketing.service.TemplateInfoService;
import com.zzuli.po.EmailInfo;
import com.zzuli.po.StaffInfo;
import com.zzuli.po.TemplateInfo;
...
public class EmailInfoController {
	...
	public String load(Integer messafeId, Model model) {
		...
		List<TemplateInfo> templist = templateInfoService
				.getTemplateInfoList(info);
