<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,com.zzuli.po.*,com.zzuli.system.dto.*"%>
<%
...
<%--							src="resources/assets/avatars/user.jpg" alt="Jason's Photo" /> --%>
							<span
							class="user-info"> <small>欢迎光临,</small>${student.studentName }
						</span> <i class="icon-caret-down"></i>
					</a>
						<ul
							class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<!-- todo添加个人资料处理 存在bug，框架容易乱掉 -->
